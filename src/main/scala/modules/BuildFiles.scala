...
import scala.util.Try
 ...
 case object BuildFiles extends ResourceLoader {
   ...
   def buildProperties: Try[String] = Try("sbt.version=1.12.3") //TODO: mae it retrive latest stable version

   def plugins: Try[String] = Try("""addSbtPlugin("org.scala-native" % "sbt-scala-native" % "0.4.17")""")

   def dckerComposeFile: Try[String] = loadTemplate("typeLevel", "docker-compose.yml")
